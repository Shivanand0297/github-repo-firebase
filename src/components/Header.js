    ...
    <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-900">
      <div className="container flex flex-wrap items-center justify-between mx-auto">
        <Link to="/" className="flex items-center">
          <img
            src="https://lh3.googleusercontent.com/Eqky-nok6uaZbukLwf7xsq0HIsBp0z7YI0G1UwOxcz0HjNkH4UKn9TJGg14YpQXY_TyaNLYvM-MI7MfLzq7g3XgrRQ=w640-h400-e365-rj-sc0x00ffffff"
            className="h-8 mr-3 sm:h-12 w-auto rounded-full"
            alt="GitHub Search"
          />
          <span className="self-center text-xs sm:text-xl font-semibold whitespace-nowrap dark:text-white">
            GitHub Search
          </span>
